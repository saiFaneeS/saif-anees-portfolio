        ...
        <div className="w-1/2 max-sm:w-4/5 shrink-0 aspect-video overflow-hidden relative transition-all border border-gray-900">
          {projects?.[currentProjectIndex]?.url && (
            <Link
              ...
              className=""
            >
              <button className="flex hover:gap-4 leading-none gap-2 items-center justify-center bg-emerald-600/80 hover:bg-emerald-800 text-white text-sm py-2 px-4 font-medium absolute bottom-4 left-1/2 -translate-x-1/2 transition-all w-fit rounded-full">
                Visit
