...
export const TrustIndicators = () => {
  ...
  return (
    <div className="relative bg-sky-600/10 flex items-center max-sm:items-start justify-center gap-2 w-full sm:w-96 max-sm:rounded-md max-sm:backdrop-blur-3xl shadow-3xl max-sm:border-sky-950/10 max-sm:border-2 p-3 px-4 rounded-md overflow-hidden">
