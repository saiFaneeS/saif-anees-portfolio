...
export const TrustIndicators = () => {
  ...
  return (
    <div className="flex items-center max-sm:items-start justify-center max-sm:flex-col gap-2 text-white-100/90 lg:bg-white lg:shadow lg:py-1 lg:px-4 rounded-full">
