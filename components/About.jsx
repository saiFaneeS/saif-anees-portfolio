      ...
      >
        ...
        <div className="h-full w-full flex flex-col justify-center lg:w-4/5">
          ...
          <p className="text-base ">
            ...
            satisfaction. When I&apos;m not building, I&apos;m learning new
            stuff.
          </p>
          ...
          <div className="grid grid-cols-4 max-md:grid-cols-3 max-sm:grid-cols-2 gap-2 gap-y-4 mb-6">
            <div className="flex items-center gap-2 grayscale hover:grayscale-0 brightness-[20%] hover:brightness-100  font-medium">
              <Image
            ...
            <div className="flex items-center gap-2 grayscale hover:grayscale-0 brightness-[90%] hover:brightness-100  font-medium">
              <Image
                src={"/icons/wp.svg"}
                className="h-5 w-5"
                alt=""
